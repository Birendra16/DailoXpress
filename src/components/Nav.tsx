    ...
    const sideBar = menuOpen ? createPortal(
        <AnimatePresence>
            <motion.div
                ...
                from-green-800/90 via-green-700/80 to-green-900/90 backdrop-blur-xl border-r
                border-green-400/20 shadow-[0_0_50px_-10px_rgba(0,255,100,0.3)] flex flex-col
                p-6 text-white'
            >
                ...
                transition-all shadow-inner'>
                    ...
                    border-green-400/60 shadow-lg'>
                        {user?.image ? <Image src={user.image} alt="user" fill sizes="40px"
                            className='object-cover rounded-full' /> : <User />}
                    </div>
    ...
    to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-14 px-4 md:px-8 z-50'>
            ...
            {role == "user" &&
                ...
                >
                    ...
                    <input type="text" placeholder='Search groceries...' className='width-full outline-none 
            ...
            <div className='flex items-center gap-3 md:gap-6 relative'>
                ...
                {role == "user" &&
                    <>
                        ...
                        <Link href={"/user/cart"} className='relative bg-white rounded-full w-10 h-10 flex items-center justify-center
        ...
        shadow-md hover:scale-105 transition-transform cursor-pointer'
                        onClick={() => user ? setOpen(prev => !prev) : router.push("/login")}
                    >
                        ...
                        {open &&
                            ...
                            >
                                <div className='flex items-center gap-3 px-3 py-2 border-b border-gray-100'>
                                    ...
                                    <div className='relative w-9 h-9 rounded-full bg-green-100 flex items-center justify-center overflow-hidden'>
                                        {user?.image ? <Image src={user.image} alt="user" fill sizes="40px" className='object-cover rounded-full' /> : <User />}
                                    </div>

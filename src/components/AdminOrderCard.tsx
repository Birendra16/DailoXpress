    ...
    >
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div className="space-y-1">
                <p className="text-base font-bold flex items-center gap-2 text-green-700">
                <Package size={18}/>
                ...
                <div className="mt-3 space-y-1 text-gray-700 text-xs">
        ...
        <div className="border-t border-gray-200 mt-2 pt-2">
            ...
            className="w-full flex justify-between items-center text-xs font-medium text-gray-700
            ...
            {expanded?<ChevronUp size={14} className="text-green-600"/>:
        ...
        <div className="border-t pt-2 mt-2 flex justify-between items-center text-xs font-semibold
        text-gray-800">

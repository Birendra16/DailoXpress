  ...
  return (
    ...
    py-10 bg-white relative'>
        ...
        >
            ...
            <input type="text" placeholder="Your Name" className='w-full border border-gray-300
            ...
            <input type={showPassword?"text":"password"} placeholder="Your Password" className='w-full border border-gray-300
            rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 
            focus:outline-none'
